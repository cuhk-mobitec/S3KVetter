...
from ..parameters import parse_authorization_code_response,my_parse_authorization_code_response
...
class WebApplicationClient(Client):
    ...
    def my_parse_request_uri_response(self, uri, params, state=None):
        response = my_parse_authorization_code_response(uri, params, state=state)
        self._populate_attributes(response)
        return response
    def my_parse_token_response(self, body):
