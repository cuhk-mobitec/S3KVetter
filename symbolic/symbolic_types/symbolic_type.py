	...
	def _eq_worker(self, expr1, expr2):
		...
		if isinstance(expr1, list):
			return len(expr1) == len(expr2) and\
			       type(expr1[0]) == type(expr2[0]) and expr1[0] == expr2[0] and\
...
class SymbolicObject(SymbolicType,object): 
	...
	# When we generate new Symbolic Object, we need to initialize SI to an appropriate value.
